...
if (!member.guild.roles.cache.has(veri) || !member.guild.channels.cache.has(kanalver.kanal))
  ...
  if (member.user.bot) {
    ...
    member.guild.channels.cache.get(kanalver).send(`**${member} Adlı Bot Sunucuya Giriş Yaptı Rol Başarıyla Verildi!**`);
  };
});
